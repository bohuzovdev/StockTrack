      ...
      <main className="flex-1 p-8 ml-64">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-slate-900">Portfolio Forecast</h1>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-semibold text-slate-900 mb-2">Scenario Explanations</h4>
                  <div className="space-y-3 text-sm text-slate-600">
                    <div>
                      <strong className="text-amber-600">Conservative (7.5%):</strong> Below historical average, accounting for potential economic headwinds or market volatility.
                    </div>
                    <div>
                      <strong className="text-blue-600">Expected (10.5%):</strong> Based on actual S&P 500 performance over the last 50 years including dividend reinvestment.
                    </div>
                    <div>
                      <strong className="text-green-600">Optimistic (13.5%):</strong> Above historical average, reflecting periods of strong economic growth and market expansion.
                    </div>
                  </div>
                </div>
              ...
              <div className="border-t pt-4 mt-6">
                <h4 className="font-semibold text-slate-900 mb-2">Important Disclaimers</h4>
